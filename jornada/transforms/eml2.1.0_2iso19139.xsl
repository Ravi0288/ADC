		...
		<gmd:MD_Metadata
			...
			<gmd:identificationInfo>
				<gmd:MD_DataIdentification>
					...
					<xsl:if test="dataset/maintenance/maintenanceUpdateFrequency">		
							...
							<gmd:maintenanceAndUpdateFrequency>
								<gmd:MD_MaintenanceFrequencyCode codeList="http://standards.iso.org/iso/19139/resources/gmxCodelists.xml#MD_MaintenanceFrequencyCode">
									<xsl:attribute name="codeListValue">
										<xsl:value-of select='dataset/maintenance/maintenanceUpdateFrequency/text()'/>
									</xsl:attribute>
					...
					<gmd:descriptiveKeywords test="dataset/coverage/geographicCoverage/geographicDescription">
						<gmd:MD_Keywords>
							<gmd:keyword>
								<gco:CharacterString><xsl:value-of select="translate(dataset/coverage/geographicCoverage/geographicDescription,'&quot;', '')"/></gco:CharacterString>
							</gmd:keyword>
							<gmd:type>
					...
					<!-- <gmd:descriptiveKeywords>
						<gmd:MD_Keywords>
							<gmd:keyword>
								<gco:CharacterString>Agricultural Research Service</gco:CharacterString>
							</gmd:keyword>
							<gmd:type>
								<gmd:MD_KeywordTypeCode codeList="http://standards.iso.org/iso/19139/resources/gmxCodelists.xml#MD_KeywordTypeCode" codeListValue="theme"/>
							</gmd:type>
